...
BACKUP LOG RestTest TO DISK = 'C:\DBP_backups\RestTest_log_t1.bak'
...
BACKUP DATABASE RestTest TO DISK = 'C:\DBP_backups\RestTest_differential_t3.bak' WITH DIFFERENTIAL
...
BACKUP LOG RestTest TO DISK = 'C:\DBP_backups\RestTest_log_t4.bak'
